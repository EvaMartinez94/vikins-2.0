...
class WarTest {
  ...
  //    @Test
  //    public void
  // vikingAttack_should_return_result_of_calling_receiveDamage_of_a_Saxon_with_the_strength_of_a_Viking() {
  //        war.addSaxon(saxon);
  //        war.addViking(viking);
  //        saxon.setHealth(150);
  ...
  //    @Test
  //    public void
  // saxonAttack_should_return_result_of_calling_receiveDamage_of_a_Viking_with_the_strength_of_a_Saxon() {
  //        war.addSaxon(saxon);
  //        war.addViking(viking);
  //        String response = war.saxonAttack();
  //        assertEquals(viking.getName() + "has received" + saxon.getStrength() + "points of
  // damage", response);
  //    }
}
